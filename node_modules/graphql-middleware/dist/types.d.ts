import { GraphQLField, GraphQLResolveInfo, GraphQLSchema, GraphQLTypeResolver, GraphQLIsTypeOfFn } from 'graphql';
...
export interface IResolverOptions<TSource = any, TContext = any> extends GraphQLField<any, any, any> {
    fragment?: string;
    fragments?: string[];
